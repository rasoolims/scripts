...
command='nice java -jar -Xmx40g '+ yara_jar+' train -cluster_id '+cluster_path+' -train-file '+train_file+' -model '+model_path+'.partial7 iter:'+iter2
os.system(command)

###############################################################################################################

print colored('partially parsing partial 5 trees','red')
command='nice java -jar -Xmx40g '+yara_jar+' parse_partial -model '+model_path+'.partial7_iter'+iter2+' -input '+partial5_conll_path +' -output '+partial5_conll_path+'.filled -score '+partial5_conll_path+'.score'
os.system(command)
...
command='nice java -jar -Xmx40g '+ yara_jar+' train -cluster_id '+cluster_path+' -train-file '+train_file+' -model '+model_path+'.partial5 iter:'+iter3
os.system(command)

###############################################################################################################

print colored('partially parsing partial all trees','red')
command='nice java -jar -Xmx40g '+yara_jar+' parse_partial -model '+model_path+'.partial5_iter'+iter3+' -input '+partial_all_conll_path +' -output '+partial_all_conll_path+'.filled -score '+partial_all_conll_path+'.score'
os.system(command)
...
command='nice java -jar -Xmx40g '+ yara_jar+' train -cluster_id '+cluster_path+' -train-file '+train_file+' -model '+model_path+'.partial_all iter:'+iter4
os.system(command)
...
command='nice java -jar -Xmx40g '+ yara_jar+ ' parse_conll -model '+model_path+'.partial_all_iter'+iter4+' -input '+gold_test_file +' -output '+model_path+'.test'
os.system(command)

print colored('evaluating the test results','red')
command='nice java -jar -Xmx40g '+ yara_jar+ ' eval -gold '+gold_test_file +' -parsed '+model_path+'.test'
os.system(command)

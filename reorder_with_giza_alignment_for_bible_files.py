...
for f in os.listdir(bible_folder):
	...
	l2_output = folder+ l1+'2'+l2+'.giza.reorder'
	l2_output_txt = folder+ l1+'2'+l2+'.giza.reorder.txt'
	l1_output = folder+ l2+'2'+l1+'.giza.reorder'
	l1_output_txt = folder+ l2+'2'+l1+'.giza.reorder.txt'

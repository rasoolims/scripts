...
os.system('nice java -Xmx20g -jar '+jar_path+' parse_conll --test-file '+full_tree_path+' --out '+full_parsed2_path+' --inf-file '+m_file +' --model-file '+ m_file+'_iter'+str(full_iter))

# constraint parse the partial data
os.system('nice java -Xmx20g -jar '+jar_path+' parse_partial --test-file '+partial_tree_path+' --out '+partial_parsed2_path+' --inf-file '+m_file +' --model-file '+ m_file+'_iter'+str(full_iter))
...
# parse the train data again
os.system('nice java -Xmx20g -jar '+jar_path+' parse_conll --test-file '+all_parsed2_path+' --out '+all_parsed3_path+' --inf-file '+m_file +' --model-file '+ m_file+'_iter'+str(full_iter))

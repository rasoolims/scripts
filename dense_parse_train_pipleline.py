...
command='nice java -jar '+ yara_jar+' train -cluster '+cluster_path+' -train-file '+full_conll_path+' -model '+model_path+'.full iter:'+iter1
os.system(command)
...
command='nice java -jar '+ yara_jar+' train -cluster '+cluster_path+' -train-file '+train_file+' -model '+model_path+'.partial7 iter:'+iter2
os.system(command)
...
command='nice java -jar '+ yara_jar+' train -cluster '+cluster_path+' -train-file '+train_file+' -model '+model_path+'.partial5 iter:'+iter3
os.system(command)
...
command='nice java -jar '+ yara_jar+' train -cluster '+cluster_path+' -train-file '+train_file+' -model '+model_path+'.partial_all iter:'+iter4
os.system(command)

...
if len(sys.argv)<12:
	print colored('arguments: yara_jar full_conll_path partial7_conll_path partial5_conll_path partial_all_conll_path model_path iter1 iter2 iter3 iter4 target_dir cluster_path','red')
	sys.exit(0)
...
command='nice java -jar '+ yara_jar+' train -cluster '+cluster_path+' -train-file '+full_conll_path+' -model '+model_path+' iter:'+iter1
os.system(command)

##############################################################################################################

print colored('partially parsing partial 7 trees','red')
command='nice java -jar '+yara_jar+' parse_partial -model '+model_path+' -input '+partial7_conll_path +' -output '+partial7_conll_path+'.filled -score '+partial7_conll_path+'.score'
os.system(command)
...
command='nice java -jar '+ yara_jar+' train -cluster '+cluster_path+' -train-file '+train_file+' -model '+model_path+'  iter:'+iter2
os.system(command)

###############################################################################################################

print colored('partially parsing partial 5 trees','red')
command='nice java -jar '+yara_jar+' parse_partial -model '+model_path+' -input '+partial5_conll_path +' -output '+partial5_conll_path+'.filled -score '+partial5_conll_path+'.score'
os.system(command)
...
command='nice java -jar '+ yara_jar+' train -cluster '+cluster_path+' -train-file '+train_file+' -model '+model_path+' iter:'+iter3
os.system(command)

###############################################################################################################

print colored('partially parsing partial all trees','red')
command='nice java -jar '+yara_jar+' parse_partial -model '+model_path+' -input '+partial_all_conll_path +' -output '+partial_all_conll_path+'.filled -score '+partial_all_conll_path+'.score'
os.system(command)
...
command='nice java -jar '+ yara_jar+' train -cluster '+cluster_path+' -train-file '+train_file+' -model '+model_path+' iter:'+iter4
os.system(command)

...
if len(sys.argv)<12:
	print colored('arguments: yara_jar full_conll_path partial7_conll_path partial5_conll_path partial_all_conll_path model_path iter1 iter2 iter3 iter4 target_dir cluster_id_path cluster_path','red')
	sys.exit(0)
...
command='nice java -Xmx30g -jar '+ yara_jar+' train -cluster '+cluster_path +' -cluster_id '+ cluster_id_path +' -train-file '+full_conll_path+' -model '+model_path+' iter:'+iter1
print command
os.system(command)
...
command='nice java -Xmx30g -jar '+ yara_jar+' train -cluster '+cluster_path +' -cluster_id '+ cluster_id_path +' -train-file '+train_file+' -model '+model_path+'  iter:'+iter2
os.system(command)
...
command='nice java -Xmx30g -jar '+ yara_jar+' train -cluster '+cluster_path +' -cluster_id '+ cluster_id_path +' -train-file '+train_file+' -model '+model_path+' iter:'+iter3
os.system(command)
...
command='nice java -Xmx30g -jar '+ yara_jar+' train -cluster '+cluster_path +' -cluster_id '+ cluster_id_path +' -train-file '+train_file+' -model '+model_path+' iter:'+iter4
os.system(command)

...
for f in os.listdir(input_folder):
	...
	if not os.path.isdir(model_path+l ):
		print 'skipped', f
		continue
	command = 'nice python -u ' + python_path+ ' --predict --test '+ input_folder+f +' --model '+model_path+l + '/model --params '+ model_path+l+'/params.pickle --output ' + output_folder+f + ' --extrn '+embed_path + l+ '.gz '
	print command
	os.system(command)

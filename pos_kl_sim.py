...
print 'kl',kl(read_ngram_counts(os.path.abspath(sys.argv[1])),read_ngram_counts(os.path.abspath(sys.argv[2])))
print 'cosine',cosine_similarity(read_ngram_counts(os.path.abspath(sys.argv[1])),read_ngram_counts(os.path.abspath(sys.argv[2])))

...
if len(sys.argv)<6:
	print 'ud_pipe_script model_folder input_conllu_folder output_conllu_folder num_thread'
	sys.exit(0)
...
for f in sorted(os.listdir(input_folder)):
	...
	command = ud_pipe_script +' '+model_file+' --tag '+ input_folder+f +' > '+output_folder+f
	i+=1
